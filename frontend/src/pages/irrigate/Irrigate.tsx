...
const Irrigate: React.FC = () => {
  ...
  return (
    <IonPage>
      {create && (
        <Redirect
          to="/dashboard/page/Irrigate/create"
          push={true}
          exact={true}
        />
      )}
      {update && (
        <Redirect
          to={`/dashboard/page/Irrigate/${irrigateId}/update`}
          push={true}
          exact={true}
        />
      )}
            ...
            <IonCard key={index}>
              <IonCardHeader>
                ...
                <IonCardSubtitle>
                  ...
                  {`${irrigate.amountWater} ${t(
                    'IRRIGATE_AQUA_QUANTITY_TYPE'
                  )}`}
                </IonCardSubtitle>
              </IonCardHeader>
              <IonCardContent>
                ...
                <IonItem lines="none">
                  <IonInput value={irrigate.createdAt} disabled />
                </IonItem>
                <IonItem>
