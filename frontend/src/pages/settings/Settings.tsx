...
const Settings: React.FC = () => {
  ...
  const [languageRef, setLanguageRef] = useState<HTMLIonSelectElement | null>(
    null
  );
  const [eventActionRef, setEventActionRef] =
  ...
  return (
    <IonPage>
      {back && <Redirect to="/dashboard" exact={true} />}
      <IonHeader>
        <IonToolbar>
          ...
          >
            ...
            <IonItem>
              <IonIcon
                ...
                className="component-icon component-icon-dark"
              />
              <IonLabel position="floating">{t('SETTING_LANGUAGE')}</IonLabel>
              <IonSelect
                ref={(languageRef) => {
                  setLanguageRef(languageRef);
                }}
                name="language"
            ...
            <IonItem>
              ...
              <IonSelect
                ref={(eventActionRef) => {
                  setEventActionRef(eventActionRef);
                }}
                name="action"
                value={settings?.defaultEventAction}
              >
