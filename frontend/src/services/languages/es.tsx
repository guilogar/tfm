const GENERAL_LANG = {
  SEARCH: 'Buscar',
  ACTIONS: 'Acciones',
  WAIT: 'Se esta cargando tu información. Por favor, espera...',
};
...
const MENU_LANG = {
  ...
  HISTORIC_AND_PREDICTIONS: 'Histórico y predicciones',
};
...
const SPECIFIC_HISTORIC_PREDICTIONS = {
  SPECIFIC_HISTORIC_PREDICTIONS_CHOOSE_HISTORIC_INTERVAL:
    'Elegir el intervalo de datos históricos',
  SPECIFIC_HISTORIC_PREDICTIONS_LAST_ONE_MONTH: 'Último mes',
  SPECIFIC_HISTORIC_PREDICTIONS_LAST_THREE_MONTHS: 'Últimos 3 meses',
  SPECIFIC_HISTORIC_PREDICTIONS_LAST_SIX_MONTHS: 'Últimos 6 meses',
  SPECIFIC_HISTORIC_PREDICTIONS_CHOOSE_PREDICTION_INTERVAL:
    'Elegir el intervalo de datos predecidos',
  SPECIFIC_HISTORIC_PREDICTIONS_NEXT_ONE_MONTH: 'Siguiente mes',
  SPECIFIC_HISTORIC_PREDICTIONS_NEXT_THREE_MONTHS: 'Siguientes 3 meses',
  SPECIFIC_HISTORIC_PREDICTIONS_NEXT_SIX_MONTHS: 'Siguientes 6 meses',
  SPECIFIC_HISTORIC_PREDICTIONS_NO_DATA_EXISTS:
    'Lo sentimos, no existen datos.',
};
