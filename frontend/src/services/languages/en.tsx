...
const HOME_LANG = {
  ...
  HOME_PHYTOSANITARY_DESCRIPTION:
    'You can manage your phytosanitary comfortably',
...
const FARMABLE_LAND_LANG = {
  ...
  FARMABLE_LAND_SQUARE_MESSAGE:
    'As the terrain is not rectangular, please draw the shape it has (it is only to have an idea of ​​how the terrain is on the part of the administration)',
...
const HISTORIC_PREDICTIONS = {
  HISTORIC_PREDICTIONS_LIST: 'Historic and predictions',
};

const SPECIFIC_HISTORIC_PREDICTIONS = {
  SPECIFIC_HISTORIC_PREDICTIONS_CHOOSE_HISTORIC_INTERVAL:
    'Choose the historic data interval',
  SPECIFIC_HISTORIC_PREDICTIONS_LAST_ONE_MONTH: 'Last month',
  SPECIFIC_HISTORIC_PREDICTIONS_LAST_THREE_MONTHS: 'Last 3 months',
  SPECIFIC_HISTORIC_PREDICTIONS_LAST_SIX_MONTHS: 'Last 6 months',
  SPECIFIC_HISTORIC_PREDICTIONS_CHOOSE_PREDICTION_INTERVAL:
    'Choose the predicted data interval',
  SPECIFIC_HISTORIC_PREDICTIONS_NEXT_ONE_MONTH: 'Last month',
  SPECIFIC_HISTORIC_PREDICTIONS_NEXT_THREE_MONTHS: 'Last 3 months',
  SPECIFIC_HISTORIC_PREDICTIONS_NEXT_SIX_MONTHS: 'Last six months',
  SPECIFIC_HISTORIC_PREDICTIONS_NO_DATA_EXISTS: 'Sorry, no data exists.',
};
...
const NOTIFICATION_LANG = {
  ...
  NOTIFICATION_DESCRIPTION_4:
    'Click here to perform the action associated with the event',
  NOTIFICATION_DESCRIPTION_5:
    'The automated action has been performed. Click here for more information',
};
...
const REFRESHER_LANG = {
  REFRESHER_UPDATE_COMPLETED: 'Update completed.',
};
